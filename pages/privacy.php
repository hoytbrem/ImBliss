...
<head>
    ...
    renderHeader("Privacy", $dirLevel); // Meta data, BootStrap, Stylesheet(s), Scripts 
    ?>
</head>
...
<body>
    ...
    <div style="max-width: 50%; margin: auto;">
        ...
        <p> * Company (referred to as either "the Company", "We", "Us" or "Our" in this
            Agreement) refers to ImBliss, 3959 Fairlands Drive, Pleasenton CA 94588.</p>
        ...
        <p> * Website refers to ImBliss, accessible from https: //imbliss.com</p>
        ...
        <p> * By email: imbliss@gmail.com
        </p>
        <p> * By visiting this page on our website: https: //imbliss.com/contact</p>
        <p> * By phone number: +1-510-555-0204</p>
        <p> * By mail: 3959 Fairlands Drive, Pleasenton CA 94588</p>
        <p> RETURNS ----</p>
        <p> Due to the nature of our perishable products, we do not accept returns.
            However, we have a 30-day refund policy, which means you have 30 days after
            receiving your item to request a refund or exchange. To be eligible for a
            refund, you must provide proof your order arrived damaged, incorrect or
            unsatisfactory. The item must be in the same condition that you received it,
            unworn or unused, with tags, and in its original packaging. You'll also need
            the receipt or proof of purchase. To start a ticket, you can contact us at imbliss@gmail.com . If your
            refund is accepted, we’ll send you a digital refund and confirmation email, or provide store credit for you
            to reorder items. Perishable items sent back to us will not be accepted. However, you may request a free
            label to return merchandise items, including unused clothing, bags or dishware. You can always contact us
            for any return questions at
            imbliss@gmail.com .</p>
        <p> Damages and Issues Please inspect your order upon receipt and contact us
            immediately if the item is defective, damaged, or if you receive the wrong
            item, so that we may evaluate the issue and make it right. Certain types of
            items cannot be returned, like perishable goods (such as food, flowers, or
            plants), and custom products (such as special orders or personalized items).
            Please get in touch if you have questions or concerns about your specific item.
            Unfortunately, we cannot accept returns on sale items. Exchanges The fastest
            way to ensure you get what you want is to create a ticket for the faulty order
            you have, and once the return is accepted, make a separate purchase for the new
            item.</p>
        <p> European Union 3 day cooling off period Notwithstanding the above, if
            merchandise is being shipped into the European Union, you have the right to
            cancel or return your order within 3days for any reason and without
            justification. As above, your item must be in the same condition that you
            received it, unworn or unused, with tags, and in its original packaging. You’ll
            also need the receipt or proof of purchase.</p>
        <p> Refunds We will notify you once we’ve received and inspected your ticket to
            ...
            process and post the refund too. If more than 15 business days have passed
            since we’ve approved your refund, please contact us at
            imbliss@gmail.com
        </p>
    </div>
</body>